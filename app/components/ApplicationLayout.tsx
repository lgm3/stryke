...
function ButtonList({ activeModule }: ButtonListProps) {
  return (
    <ul className="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content border-x-2 border-primary gap-2">
      <li>
...
export default function ApplicationLayout({
  ...
  return (
    <div className="drawer drawer-mobile">
      ...
      <div className="drawer-content flex flex-col items-center p-8">
        {children}
      </div>
